# Copiamos las funciones que vemos que se van a utilizar en el ejercicio 04.2
...
def get_more_often_user_words(frequencies, threshold=10):
    ...
    """
    frequencies = frequencies.copy() #debemos hacer una copia para que no se nos eliminen.
    result = []
    while True:
